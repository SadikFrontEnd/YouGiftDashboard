...
const contact = lazy(() => import("./views/apps/contact/Contact"));
const myGift = lazy(() => import("./views/apps/myGift/MyGifts"));
const shops = lazy(() => import("./views/apps/shop/Shop"));
const customeShop = lazy(() => import("./views/apps/customeShop/CustomeShop"));
const affiliate = lazy(() => import("./views/apps/affiliate/Affiliate"));
    ...
    return (
      ...
      <Router history={history}>
        ...
        <AppRoute exact path="/" component={analyticsDashboard} />
          ...
          <AppRoute path="/myGift" component={myGift} />
          <AppRoute path="/shop" component={shops} />
          <AppRoute path="/customeShop" component={customeShop} />
          <AppRoute path="/affiliate" component={affiliate} />
          <AppRoute
            path="/todo"
            exact
